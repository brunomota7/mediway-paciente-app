...
export default function AddVaccineScreen({ navigation }) {
  ...
  const handleSalvar = () => {
    ...
    console.log({ vacinaSelecionada, tipoDose, dataVacinou, lote, dataFabricacao });
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.header}>
        <MaterialCommunityIcons name="shield-plus" size={28} color="#4caf50" />
      ...
      <View style={styles.formGroup}>
        ...
        <TouchableOpacity onPress={() => setShowDataVacinou(true)} style={styles.dateInput}>
        ...
        <TouchableOpacity onPress={() => setShowDataFabricacao(true)} style={styles.dateInput}>
