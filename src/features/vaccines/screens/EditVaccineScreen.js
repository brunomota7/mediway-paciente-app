...
export default function EditVaccineScreen({ route, navigation }) {
  ...
  const [dataVacinou, setDataVacinou] = useState(
    new Date("2023-02-12T08:30:00")
  );
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.patientInfo}>
          ...
          <Text style={styles.patientDetails}>
            Nascimento: 23/11/1975 | Idade: 49 | Sexo: Masculino
          </Text>
        </View>
        ...
        <View style={styles.formGroup}>
          ...
          <View style={styles.pickerWrapper}>
            <Picker
              ...
              onValueChange={(item) => setVacinaSelecionada(item)}
            >
          ...
          <View style={styles.pickerWrapper}>
            <Picker
              ...
              onValueChange={(item) => setTipoDose(item)}
            >
