        ...
        <View style={styles.modalContainer}>
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>
              Apenas cuidadores já cadastrados como membro de Equipe
              Multidisciplinar no aplicativo Mediway podem ser adicionados. Caso
              ainda não esteja cadastrado, peça que se cadastre.
            </Text>
          </View>
          ...
          {membroSelecionado && (
            <View style={styles.detailsBox}>
              ...
              <Text style={styles.detailText}>
                📌 Especialidade: {membroSelecionado.especialidade}
              </Text>
            </View>
          )}
